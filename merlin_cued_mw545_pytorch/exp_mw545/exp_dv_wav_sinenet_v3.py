...
# Then within each window, split into smaller windows
...
class dv_y_wav_cmp_configuration(dv_y_configuration):
    ...
    def __init__(self, cfg):
        ...
        self.nn_layer_config_list = [
            ...
            {'type':'SinenetV3', 'size':40, 'num_channels':4, 'win_len':640, 'win_shift':40, 'channel_combi':'stack', 'dropout_p':0, 'batch_norm':False},
