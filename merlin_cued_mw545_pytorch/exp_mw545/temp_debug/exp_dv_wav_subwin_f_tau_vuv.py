# exp_dv_wav_subwin_f_tau_vuv.py
...
# Then, append f and tau information to smaller windows
...
from exp_mw545.exp_dv_cmp_pytorch import list_random_loader, dv_y_configuration, make_dv_y_exp_dir_name, make_dv_file_list, train_dv_y_model, class_test_dv_y_model, distance_test_dv_y_model, vuv_test_dv_y_model
...
class dv_y_wav_subwin_configuration(dv_y_configuration):
    ...
    def __init__(self, cfg):
        super().__init__(cfg)
        self.use_voiced_only = True # Use voiced regions only for training; weighted CE criterion
        ...
        self.nn_layer_config_list = [
            ...
            {'type':'ReLUSubWin_f_tau_vuv_ST', 'size':80, 'win_len_shift_list':[[self.batch_seq_len, self.batch_seq_shift], [self.seq_win_len, self.seq_win_shift]], 'total_length':self.batch_seq_total_len, 'dropout_p':0, 'batch_norm':False},
