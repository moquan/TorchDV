# exp_dv_wav_sinenet_v0_lab_attention.py
...
class dv_wav_sinenet_lab_attention_configuration(dv_attention_configuration):
    ...
    def __init__(self, cfg, dv_y_cfg, cache_files=True):
        ...
        self.y_model_name = 'sinenet_v0_frame'
        self.load_y_model = True
        self.prev_y_model_name = '/home/dawna/tts/mw545/TorchDV/dv_wav_sinenet_v0/dvy_wav_lr1E-04_fpu40_Sin80af64ks0.5_LRe512L_LRe512L_Lin512L_DV512S10T3000TM240/Model'
...
def train_model(cfg, dv_attn_cfg=None, dv_y_cfg=None):
    if dv_attn_cfg is None:
        ...
        dv_attn_cfg = dv_wav_sinenet_lab_attention_configuration(cfg, dv_y_cfg)
