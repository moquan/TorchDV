...
cd /data/vectra2/tts/mw545/TorchTTS/espnet_py36/espnet/egs2/CUED_vctk/tts_integrated
# spk_model_name=cmp
# train_spk_dataset_type=cmp_binary_86_40
# inference_spk_dataset_type=cmp_binary_86_40

# spk_model_name=sincnet_lr6
# train_spk_dataset_type=wav_binary_3000_1200
# inference_spk_dataset_type=wav_binary_3000_120
# init_param=/data/vectra2/tts/mw545/TorchTTS/espnet_py36/espnet/egs2/CUED_vctk/tts_2_stage/exp/tts_train_raw_phn_tacotron_g2p_en_no_space_sincnet_dynamic_5_seconds/valid.loss.best.pth
...
# train_spk_dataset_type=wav_f_tau_vuv_binary_3000_1200
# inference_spk_dataset_type=wav_f_tau_vuv_binary_3000_120
...
spk_model_name=sinenet_v2_lab_lr0
# spk_model_name=sinenet_v2_lab_lr5
# train_spk_dataset_type=wav_f_tau_vuv_lab_binary_3000_3000_5
train_spk_dataset_type=wav_f_tau_vuv_lab_binary_3000_1200_5
...
# init_param=/data/vectra2/tts/mw545/TorchTTS/espnet_py36/espnet/egs2/CUED_vctk/tts_integrated/exp/tts_train_sinenet_v2_lab_lr5_tacotron2_raw_phn_tacotron_g2p_en_no_space_seed2_sinenet_v2_lab_lr5_dynamic_5_seconds/valid.loss.best.pth
...
# Training
if false; then
    ./run.sh --stage 5 --stop-stage 5 --use_spk_model true --train_config conf/train_${spk_model_name}_tacotron2.yaml --train_spk_dataset_name ${train_spk_dataset_name} --train_spk_dataset_type ${train_spk_dataset_type} --nj 4
    ./run.sh --stage 6 --stop-stage 6 --use_spk_model true --train_config conf/train_${spk_model_name}_tacotron2.yaml --train_spk_dataset_name ${train_spk_dataset_name} --train_spk_dataset_type ${train_spk_dataset_type} --init_param ${init_param}  --train_args "--seed 0"
fi

# Multiple seed training
if false; then
for seed in 0; do
    # ./run.sh --stage 6 --stop-stage 6 --use_spk_model true --train_config conf/train_${spk_model_name}_tacotron2.yaml --train_spk_dataset_name ${train_spk_dataset_name} --train_spk_dataset_type ${train_spk_dataset_type} --init_param ${init_param} --train_args "--seed ${seed}"
    ./run.sh --stage 6 --stop-stage 6 --use_spk_model true --train_config conf/train_${spk_model_name}_tacotron2.yaml --train_spk_dataset_name ${train_spk_dataset_name} --train_spk_dataset_type ${train_spk_dataset_type} --train_args "--seed ${seed}"
done
fi
...
if true; then
    ...
    inference_spk_dataset_name=same_file
    ./run.sh --stage 8 --stop-stage 8 --use_spk_model true --train_config conf/train_${spk_model_name}_tacotron2.yaml --inference_model ${inference_model}.pth --test_sets ${test_sets} --train_spk_dataset_name ${train_spk_dataset_name} --inference_spk_dataset_name ${inference_spk_dataset_name} --inference_spk_dataset_type ${inference_spk_dataset_type}  --train_args "--seed ${seed}"

fi

# Waveform generation and evaluation
seed=0
if false; then
    for num_draw in 1; do
        inference_spk_dataset_name=same_30_seconds_per_speaker_draw_${num_draw}
        # Waveform Generation
        test_sets=eval1
        if true; then
            ./run.sh --stage 7 --stop-stage 7 --use_spk_model true --train_config conf/train_${spk_model_name}_tacotron2.yaml  --inference_model ${inference_model}.pth --test_sets ${test_sets} --train_spk_dataset_name ${train_spk_dataset_name} --inference_spk_dataset_name ${inference_spk_dataset_name} --inference_spk_dataset_type ${inference_spk_dataset_type}  --inference_use_teacher_forcing false --generate_wav false --gpu_inference false --inference_nj 10 --train_args "--seed ${seed}"
            dataset_dir=exp/tts_train_${spk_model_name}_tacotron2_raw_phn_tacotron_g2p_en_no_space_seed${seed}_${train_spk_dataset_name}/decode_${inference_model}/${inference_spk_dataset_name}/${test_sets}
...
# Multi-second test, Teacher-forcing mode
if false; then
...
for num_seconds in 5 30; do
    ...
    # for num_draw in 1; do
        ...
        ./run.sh --stage 7 --stop-stage 7 --use_spk_model true --train_config conf/train_${spk_model_name}_tacotron2.yaml --inference_model ${inference_model}.pth --test_sets ${test_sets} --train_spk_dataset_name ${train_spk_dataset_name} --inference_spk_dataset_name ${inference_spk_dataset_name} --inference_spk_dataset_type ${inference_spk_dataset_type}  --inference_use_teacher_forcing true --inference_tag tf --generate_wav false --inference_keep_feats false --gpu_inference false --inference_nj 10
    done
    log_dir=exp/tts_train_${spk_model_name}_tacotron2_raw_phn_tacotron_g2p_en_no_space_${train_spk_dataset_name}/tf
