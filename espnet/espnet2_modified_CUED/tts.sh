...
if [ -z "${tts_stats_dir}" ]; then
    ...
    if "${use_xvector}"; then
        tts_stats_dir+="_${spk_embed_type}_${train_spk_dataset_name}"
    fi
    if "${use_spk_model}"; then
        tts_stats_dir+="_${train_spk_dataset_type}_${train_spk_dataset_name}"
    fi    
fi
...
if "${use_spk_model}"; then
    tts_exp+="_${train_spk_dataset_name}"
fi
